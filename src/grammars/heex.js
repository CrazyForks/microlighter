// Reference: Phoenix LiveView (MIT) — https://github.com/phoenixframework/phoenix_live_view/blob/main/assets/vscode/phoenix-heex/syntaxes/HTML%20(EEx).tmLanguage.json
export default {
  ...
  repository: {
    ...
    attributes: {
      ...
      patterns: [{ include: "#interpolation" }, { include: "text.html.basic#entities" }]
    }
  }
};